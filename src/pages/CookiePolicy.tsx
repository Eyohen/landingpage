  ...
  return (
    <LegalLayout title="Cookie Policy" updated="6 July 2026">
      ...
      <p>
        ...
        your preference — no name, no tracking — and it never leaves your device or gets shared with
        anyone. This is the one thing we keep either way, because it's how the yes/no actually works.
      </p>
      ...
      <p className="muted">
        The exact names and timings are set by Google and Microsoft and can change — this shows how
        they work today.
      </p>
